      ...
      <TabPanel value={value} index={0}>
        ...
        >
          <Typography variant="h5" sx={{ width: "60%" }}>
              Create a new index by uploading a .jsonl file. The index can include both cleaning history logs and domain rules, stored under a unique name for easy retrieval and management.
          </Typography>
            ...
            {createIndexState.isLoading ? (
              ...
              <>
                ...
                <FileInput
                  ...
                  onChange={(e) => onChangeJsonlFile(e, "create")}
                />
                <Button
                  variant="contained"
                  color="primary"
      ...
      <TabPanel value={value} index={1}>
        ...
        >
          <Typography variant="h5" sx={{ width: "60%" }}>
            ...
            Upload a single .jsonl file to add or merge into the selected index.
          </Typography>
          <Stack mt={10} spacing={2} width="38%">
            {updateIndexState.isLoading ? (
              ...
              <>
                ...
                <FileInput
                  ...
                  onChange={(e) => onChangeJsonlFile(e, "update")}
                />
                <Button
                  variant="contained"
                  color="primary"
